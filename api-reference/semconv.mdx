---
title: "@bryel/semconv"
description: "OpenInference semantic-convention constants plus bryel extensions, with no @arizeai dependency."
---

OpenInference-conformant semantic-convention constants with no `@arizeai` dependency. Install it directly only when you write a custom [`SpanMapper`](/api-reference/sdk-core#spanmapper).
