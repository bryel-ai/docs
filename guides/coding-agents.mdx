...
Seven tools, scoped to the single project you picked at consent. The agent can never name another project.
...
With write enabled, an agent can assemble a fine-tune set without leaving the editor. Each record is a chat-with-tools trajectory in the bryel shape:
