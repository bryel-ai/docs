...
See the [feedback API reference](/api-reference/feedback) for every field and shorthand.
...
To capture the `messageId` upstream in the first place, see the [Vercel instrumentation](/frameworks/vercel) guide.
