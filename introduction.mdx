...
bryel is OpenTelemetry-native observability for LLM apps and agents. The SDK ships your model calls, tool calls, tokens, and cost to bryel as OpenInference traces — from any framework, not just one.
...
<CardGroup cols={2}>
  ...
  <Card title="Installation" icon="package" href="/installation">
    Pick the right package and wire up the SDK.
  </Card>
