...
<CardGroup cols={2}>
  <Card title="Vercel AI SDK" icon="bolt" href="/frameworks/vercel">
    One processor + a per-call flag. No wrapping your model calls.
  </Card>
  <Card title="Any OpenTelemetry app" icon="diagram-project" href="/frameworks/opentelemetry">
    Already emit OpenInference spans? Add one processor and you're done.
  </Card>
  <Card title="OpenAI · Anthropic · LangChain" icon="layer-group" href="/frameworks/other">
